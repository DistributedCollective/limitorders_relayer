...
interface OrderBookMarginProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class OrderBookMarginProxy extends BaseContract {
  ...
  interface: OrderBookMarginProxyInterface;
